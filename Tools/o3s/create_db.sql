...
CREATE TABLE evaluations (
  id int(11) NOT NULL AUTO_INCREMENT,
  qsosappfamily varchar(50) CHARACTER SET utf8mb4 NOT NULL COMMENT 'software family',
  qsosspecificformat varchar(5) CHARACTER SET utf8mb4 NOT NULL,
  qsosappname varchar(50) CHARACTER SET utf8mb4 NOT NULL DEFAULT 'noname' COMMENT 'Short application name',
  release varchar(15) CHARACTER SET utf8mb4 NOT NULL DEFAULT '0',
  appname varchar(80) CHARACTER SET utf8mb4 NOT NULL DEFAULT 'noname' COMMENT 'Long application name',
  language varchar(5) CHARACTER SET utf8mb4 NOT NULL COMMENT 'Language on two characters',
  file varchar(100) CHARACTER SET utf8mb4 NOT NULL,
  licensedesc varchar(50) CHARACTER SET utf8mb4 NOT NULL COMMENT 'License name',
