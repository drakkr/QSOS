...
$query  = "SELECT qsosappfamily, qsosspecificformat, count(*) as nb";
$query .= " FROM evaluations WHERE repo = :git";
$query .= "   AND appname <> ''";
$query .= "   AND language = :lang";
$query .= " GROUP BY qsosappfamily, qsosspecificformat";
$query .= " ORDER BY qsosappfamily, qsosspecificformat";
$params= array(
 ":git" => $git,
 ":lang" => $lang
);
...
while($row = array_shift($rows)){
  ...
  echo "<td align='center' class='level1' style='width: 100px; text-align: center' $over1><a href='$link'>$row[2]</a></td>\n";
  echo "</tr>\n";
}
